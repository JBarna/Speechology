module.exports = function( _interface ){
    return function(elem){
        _interface.ask("Please say the area code of your phone number", function(areaCodeTranscript){
            var saved = this;
            ...
            if (areaCodeTranscript.length !== 3 && !isNaN(Number(areaCodeTranscript)))
                ...
                _interface.ask("Please say the remaining 7 digits of your phone number", function(remainingTranscript){
