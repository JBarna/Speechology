module.exports = function( _interface ){
    ...
    return function(elem){
        ...
        _interface.ask(question, function(transcript){
            var _this = this;
            var year, month, day;
            ...
            var findNextDatePart = function(){
                ...
                var getYear = function(){
                    _interface.ask("Please say the year you were born", function(transcript){
                ...
                var getMonth = function(){
                    _interface.ask("Please say the month you were born.", function(transcript){
                        var found = false;
                ...
                var getDay = function(){
                _interface.ask("Please say the day you were born.", function(transcript){
